<div id="loginField">
	{if $user.isGuest}
		<a href="/{$subdir}login" id="loginLink">
			<i class="icon-signin"></i>&nbsp;&nbsp;{'system.page.login.login.title'|lang}
		</a>
	{else}
		<a href="/{$subdir}login" style="margin-right: 5px;">
			<i class="icon-user"></i>&nbsp;&nbsp;{$user.name|escape}
		</a>
		<span class="icon">&mdash;</span>
		<a href="/{$subdir}login/logout" style="margin-left: 5px;">
...
{if $user.isGuest}
<div id="loginBox">
	<form action="/{$subdir}login/refer" method="post">
